...
class _MyConferenceQuestionsState extends State<MyConferenceQuestionsPage> {
  static List<Comment> comments = [
    Comment(
        ...
        DateTime.now(),
        true),
    Comment(User('', '', 'Atendee Two', 'assets/avatar2.png', '', '1234'), 'Comment 2',
        DateTime.now(), false),
    Comment(User('', '', 'Atendee Three', 'assets/avatar3.png', '', '1234'),
        'Comment 3', DateTime.now(), false),
    Comment(User('', '', 'Atendee Four', 'assets/avatar4.png', '', '1234'), 'Comment 4',
        DateTime.now(), false),
    Comment(User('', '', 'Atendee Five', 'assets/avatar5.png', '', '1234'), 'Comment 5',
        DateTime.now(), false),
  ];
